# Undo Modify by Snit to apply cuFFTW 
set(FFTW_EXTERNAL_PATH "${CMAKE_SOURCE_DIR}/external/fftw")
#set(FFTW_EXTERNAL_PATH "/usr/local/cuda")
...
#find_path(   OWN_FFTW_INCLUDES NAMES cufftw.h PATHS ${FFTW_EXTERNAL_PATH}/include NO_DEFAULT_PATH) 
#find_library(OWN_FFTW_SINGLE   NAMES libcufftw.so  PATHS ${FFTW_EXTERNAL_PATH}/lib64     NO_DEFAULT_PATH)
#find_library(OWN_FFTW_DOUBLE   NAMES libcufftw.so   PATHS ${FFTW_EXTERNAL_PATH}/lib64     NO_DEFAULT_PATH)
